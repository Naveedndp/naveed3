...
def sarfraz():   
    ...
    print(f'[W] Join Whatsapp Group https://chat.whatsapp.com/BsmPUlhkFSHDovfj6AcQzn')
    ...
    if select =='1':
       ...
       cutter()
        ...
        os.system('xdg-open Follow this link to join my WhatsApp group: https://chat.whatsapp.com/BsmPUlhkFSHDovfj6AcQzn')
        pass
    elif select =='F':
